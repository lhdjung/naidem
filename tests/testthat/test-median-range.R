...
test_that("`median_range()` works correctly with `x12`", {
  ...
  expect_equal(median_range(c(x12, rep(NA, 4))), c(-Inf, Inf))
  expect_equal(median_range(c(x12, rep(NA, 5))), c(-Inf, Inf))
})
...
test_that("`median_range()` works correctly with `x13`", {
  ...
  expect_equal(median_range(c(x13, rep(NA, 2))), c(-Inf, Inf))
  expect_equal(median_range(c(x13, rep(NA, 3))), c(-Inf, Inf))
})
...
test_that("`median_range()` works correctly with `x14`", {
  ...
  expect_equal(median_range(c(x14, rep(NA, 3))), c(-Inf, Inf))
})
...
test_that("`median_range()` works correctly with `x15`", {
  ...
  expect_equal(median_range(c(x15, rep(NA, 3))), c(-Inf, Inf))
  expect_equal(median_range(c(x15, rep(NA, 4))), c(-Inf, Inf))
...
test_that("`median_range()` works correctly with `x16`", {
  ...
  expect_equal(median_range(c(x16, rep(NA, 6))), c(-Inf, Inf))
  expect_equal(median_range(c(x16, rep(NA, 7))), c(-Inf, Inf))
})
